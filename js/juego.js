...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 870, 160, 15, 30, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 250, 500, 30, 15, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 590, 140, 30, 15, 3)
  ],
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('black',760, 539, 126 ,8);
  Dibujante.dibujarRectangulo('white',760, 547, 126 ,8);
  Dibujante.dibujarRectangulo('black',760, 555, 126 ,8);
};
